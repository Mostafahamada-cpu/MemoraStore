/* ===========================
   AUTHENTIC ARABIC WEDDING INVITATION - SCRIPT
   =========================== */
...
const CONFIG = {
    ...
    displayDate: "October 7, 2026 | 25 ربيع الآخر 1448",
...
function populateContent() {
    ...
    document.title = `دعوة زفاف | ${CONFIG.groomName} & ${CONFIG.brideName}`;
}
...
if (rsvpForm) {
    rsvpForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            formMessage.textContent = 'شكرًا لك! تم استلام ردك. Thank you! Your RSVP has been received.';
